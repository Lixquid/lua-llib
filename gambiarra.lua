-- Gambiarra is property of zserge, distributed under the MIT license.
-- Modified by Lixquid

local last_test = ""
local function TERMINAL_HANDLER(e, test, msg)
	if e == "pass" or e == "fail" or e == "except" then
		if last_test == test then
			test = string.rep( " ", #test )
		else
			last_test = test
		end
	end
	...
	if e == 'pass' then
		print("\027[32m\226\156\148\027[1m "..test..':\027[21m '..msg)
	elseif e == 'fail' then
		print("\027[31m\226\156\152\027[0m "..test..': '..msg)
